...
// Source: /home/roman/go/pkg/mod/github.com/osmosis-labs/tm-db@v0.6.6-0.20220224030238-f2d0e3e7b97c/types.go
...
func (m *MockDB) NewBatchWithSize(size int) db.Batch {
	m.ctrl.T.Helper()
...
func (mr *MockDBMockRecorder) NewBatchWithSize(size interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewBatchWithSize", reflect.TypeOf((*MockDB)(nil).NewBatchWithSize), size)
}
