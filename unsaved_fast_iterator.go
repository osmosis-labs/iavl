...
type UnsavedFastIterator struct {
	...
	unsavedFastNodeAdditions map[string]*types.FastNode
...
func NewUnsavedFastIterator(start, end []byte, ascending bool, ndb *nodeDB, unsavedFastNodeAdditions map[string]*types.FastNode, unsavedFastNodeRemovals map[string]interface{}) *UnsavedFastIterator {
