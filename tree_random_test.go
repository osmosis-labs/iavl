...
//			cacheSize = 0
//		}
//		tree, err = NewMutableTreeWithOpts()
...
//	iter, err := tree.ndb.getDb().Iterator(nil, nil)
//	require.NoError(t, err)
//
//	var (
//		foundKeys []string
...
//
//	storageVersionValue, err := tree.ndb.getDb().Get([]byte(firstKey))
//	require.NoError(t, err)
...
//	}
//
//	for key, cacheElem := range tree.ndb.getFastNodeCache() {
